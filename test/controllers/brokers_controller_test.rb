...
class BrokersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create broker" do
    assert_difference("Broker.count") do
      post brokers_url, params: { broker: { address: @broker.address, country: @broker.country, email: @broker.email, mc: @broker.mc, name: @broker.name, phone: @broker.phone, usdot: @broker.usdot } }
    end
  ...
  test "should update broker" do
    patch broker_url(@broker), params: { broker: { address: @broker.address, country: @broker.country, email: @broker.email, mc: @broker.mc, name: @broker.name, phone: @broker.phone, usdot: @broker.usdot } }
